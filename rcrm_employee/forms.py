...
class EmployeeForm(ModelForm):
    ...
    emergency_contact = CharField(label=_("Emergency Contact"), widget=TextInput(attrs={'class': 'form-control'}))
    emergency_phone_number = CharField(label=_("Emergency Phone Number"), widget=TextInput(attrs={'class': 'form-control'}))
...
class SocialProfileForm(ModelForm):
    ...
    other = CharField(label=_("Other"), required=False, widget=TextInput(attrs={'class': 'form-control'}))
