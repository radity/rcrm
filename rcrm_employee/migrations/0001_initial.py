# Generated by Django 2.0.6 on 2018-07-12 12:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rcrm_account', '0005_auto_20180712_1139'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_phone_number', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Added')),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Last Modified')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Employee_Phone', to='rcrm_employee.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='SocialProfile',
            fields=[
                ...
                ('other', models.CharField(help_text='Slack:@username', max_length=256, verbose_name='Other')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Added')),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Last Modified')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Employee_Social_Profile', to='rcrm_employee.Employee')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='email',
            name='employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Employee_Email', to='rcrm_employee.Employee'),
        ),
        migrations.AddField(
            model_name='address',
            name='employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Employee_Address', to='rcrm_employee.Employee'),
        ),
    ]
