...
from rcrm_account.views import AccountView, AccountUserCreateView, AccountRequestCreateView,\
...
urlpatterns = [
    ...
    # User Profile
    path('profile/', login_required(UserProfileView.as_view()), name='User_Profile'),
    path('profile/password/', login_required(ChangePasswordView.as_view()), name='User_Password'),
]